...
const file_create_user_proto_rawDesc = "" +
	"\n" +
	"\x11create_user.proto\x12\x0epb.create_user\x1a\n" +
	"user.proto\"~\n" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB1Z/github.com/Kartik30R/simple_bank/pb/create_userb\x06proto3"
...
var file_create_user_proto_goTypes = []any{
	(*CreateUserRequest)(nil),  // 0: pb.create_user.CreateUserRequest
	(*CreateUserResponse)(nil), // 1: pb.create_user.CreateUserResponse
	(*pb.User)(nil),            // 2: pb.User
}
var file_create_user_proto_depIdxs = []int32{
	2, // 0: pb.create_user.CreateUserResponse.user:type_name -> pb.User
