...
type SimpleBankClient interface {
	CreateUser(ctx context.Context, in *create_user.CreateUserRequest, opts ...grpc.CallOption) (*create_user.CreateUserResponse, error)
	LoginUser(ctx context.Context, in *login_user.LoginUserRequest, opts ...grpc.CallOption) (*login_user.LoginUserResponse, error)
}
...
func (c *simpleBankClient) CreateUser(ctx context.Context, in *create_user.CreateUserRequest, opts ...grpc.CallOption) (*create_user.CreateUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(create_user.CreateUserResponse)
...
func (c *simpleBankClient) LoginUser(ctx context.Context, in *login_user.LoginUserRequest, opts ...grpc.CallOption) (*login_user.LoginUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(login_user.LoginUserResponse)
...
type SimpleBankServer interface {
	CreateUser(context.Context, *create_user.CreateUserRequest) (*create_user.CreateUserResponse, error)
	LoginUser(context.Context, *login_user.LoginUserRequest) (*login_user.LoginUserResponse, error)
...
func (UnimplementedSimpleBankServer) CreateUser(context.Context, *create_user.CreateUserRequest) (*create_user.CreateUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedSimpleBankServer) LoginUser(context.Context, *login_user.LoginUserRequest) (*login_user.LoginUserResponse, error) {
...
func _SimpleBank_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(create_user.CreateUserRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).CreateUser(ctx, req.(*create_user.CreateUserRequest))
	}
...
func _SimpleBank_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(login_user.LoginUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).LoginUser(ctx, req.(*login_user.LoginUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
